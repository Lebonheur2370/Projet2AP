...
<section class="user_profile inner_pages">
  <div class="container">
    <div class="user_profile_info gray-bg padding_4x4_40">
      <div class="upload_user_logo"> <img src="assets/images/me.jpg" alt="image">
      </div>
    ...
    <div class="row">
      ...
      <div class="col-md-6 col-sm-8">
        <div class="profile_wrap">
          <h5 class="uppercase underline">Parametre</h5>
          <?php  
          ...
          <form  method="post">
           <div class="form-group">
            ...
            <div class="form-group">
              ...
              <input class="form-control white_bg" value="<?php echo htmlentities($result->EmailId);?>" name="emailid" id="emailid" type="email" required readonly>
            </div>
            <div class="form-group">
              <label class="control-label">Numéro de Phone</label>
            ...
            <div class="form-group">
              ...
              <input class="form-control white_bg" value="<?php echo htmlentities($result->Address);?>" name="address" id="address" type="text" required>
            </div>
            <div class="form-group">
