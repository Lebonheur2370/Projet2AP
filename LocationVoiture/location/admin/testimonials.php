...
$msg="Témoignage inactif avec succès ";
}
...
$msg="Témoignage actif avec succès";
}
...
<head>
	...
	<title>Admin Gère les témoignages   </title>
...
{
	?><a href="testimonials.php?aeid=<?php echo htmlentities($result->id);?>" onclick="return confirm('Voulez-vous vraiment être actif')"> Inactive</a>
<?php } else {?>

<a href="testimonials.php?eid=<?php echo htmlentities($result->id);?>" onclick="return confirm('Voulez-vous vraiment être inactif')"> Active</a>
</td>
<?php } ?></td>
										</tr>
										<?php $cnt=$cnt+1; }} ?>
