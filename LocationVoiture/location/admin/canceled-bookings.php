			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Annuler la Réservation</h2>
...
$status=2;
									...
									from tblreservation join tblvehicules on tblvehicules.id=tblreservation.VehiculeId join tblusers 
									on tblusers.EmailId=tblreservation.Email join tblmarques on tblvehicules.MarqueVehicule=tblmarques.id   where tblreservation.Status=:status";
