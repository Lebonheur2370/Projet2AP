...
$query->execute();
$msg="Mis à jour avec succés des Infos";
}
?>
...
<head>
	...
	<title> Admin une Créer une marque</title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Mettre à jour les coordonnées</h2>
...
?>	
											...
											<div class="form-group">
												<label class="col-sm-4 control-label"> Numéro de Phone </label>
												<div class="col-sm-8">
...
<?php }} ?>
											...
											<div class="form-group">
												<div class="col-sm-8 col-sm-offset-4">
													...
													<button class="btn btn-primary" name="submit" type="submit">Mise à jour</button>
												</div>
											</div>
