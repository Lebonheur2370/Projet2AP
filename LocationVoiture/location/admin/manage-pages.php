			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Gestion Pages </h2>
                  ...
                  <option value="manage-pages.php?type=aboutus">Apropos</option> 
...
?>
											...
											<div class="form-group">
												...
												<button type="submit" name="submit" value="Update" id="submit" class="btn-primary btn">Mettre a jour</button>
												</div>
											</div>
