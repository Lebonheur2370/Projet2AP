...
<head>
	...
	<title>Admin Gère les Requêtes   </title>
...
<td><a href="manage-conactusquery.php?eid=<?php echo htmlentities($result->id);?>" onclick="return confirm('Veux-tu vraiment lire')" >En attente</a>
</td>
<?php } ?>
										</tr>
										<?php $cnt=$cnt+1; }} ?>
