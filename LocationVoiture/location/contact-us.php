<?php
  ...
  if(isset($_POST['send']))
  {
    ...
    $sql="INSERT INTO  tblcontactusquery(name,EmailId,ContactNumber,Message) VALUES(:name,:emailid,:contactno,:message)";
  ...
  if($lastInsertId)
  {
    $msg="Message envoyé. nous vous contacterons dans peu de temps";
  }
  else 
  {
...
<title>Page Contactez-nous</title>
<!--Bootstrap -->
        ...
        <div class="contact_form gray-bg">
          <form  method="post">
            <div class="form-group">
              <label class="control-label">Nom & Prénom <span>*</span></label>
            ...
            <div class="form-group">
              <label class="control-label">Numéro du Phone <span>*</span></label>
        ...
        <div class="contact_detail">
          ...
          <ul>
            ...
            <li>
              ...
              <div class="contact_info_m"><a href="tel:+241 76-59-46-48"><?php   echo htmlentities($result->ContactNo); ?></a></div>
            </li>
            <li>
              <div class="icon_wrap"><i class="fa fa-envelope-o" aria-hidden="true"></i></div>
              <div class="contact_info_m"><a href="mailto:blebonheur69@gmail.com"><?php   echo htmlentities($result->EmailId); ?></a></div>
            </li>
          </ul>
        <?php }} ?>
        </div>
